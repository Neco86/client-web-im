      ...
      <div className={styles.groupInfo}>
        <div className={styles.editNickName}>
          ...
          {groupEditable ? (
            ...
            <>
              <span className={styles.showInfo}>{info.name}</span>
        ...
        <div className={styles.editNickName}>
          ...
          {nameEditable ? (
            ...
            <>
              <span className={styles.showInfo}>{info.nickName}</span>
        ...
        <div className={styles.editNickName}>
          ...
          {signEditable ? (
            ...
            <>
              <span className={styles.showInfo}>{info.sign}</span>
        ...
        <div className={styles.editNickName}>
          ...
          {groupNameEditable ? (
            ...
            <>
              <span className={styles.showInfo}>{info.groupName}</span>
