...
import { UsergroupAddOutlined, SmileOutlined, FolderOutlined, PhoneOutlined, CameraOutlined, FastForwardFilled } from '@ant-design/icons';
  ...
  useEffect(() => {
    setChatInfo({
      ...
      history: [
        ...
        {
          type: '1',
          msg: 'longMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsglongMsg',
          time: '1583995694347',
        },
      ]
    })
          ...
          chatInfo.history.map(chat => {
            switch (chat.type) {
              case '1': // 对方的消息
                return (
                  <div
                    key={`${chat.time} ${chat.type}`}
                    className={styles.peerChatMsg}
                  >
                    <div>
                    ...
                    <div className={styles.msg}>
                      {
                        chat.msg
                          ...
                          .map((msg, index) => index === 0
                            ? msg
                            : <Fragment key={+index}><br />{msg}</Fragment>)
                      }
                    </div>
                  </div>);
              default: return <div />
